...
$vodicZaKat = [
    ...
    'bambus-drveni' => ['kako-izabrati-panele-po-prostoriji.html', 'Kako izabrati panele po prostoriji'],
    'classic' => ['kako-izabrati-panele-po-prostoriji.html', 'Kako izabrati panele po prostoriji'],
];
...
<?php endif; ?>
      ...
      <div class="product-info">
        ...
        <?php endif; ?>
          ...
          <div style="display:flex;flex-direction:column;gap:10px;margin:22px 0 28px;">
            ...
            <?php else: ?>
            <button onclick="addProductToCartById(<?= (int)($product['id'] ?? 0) ?>, 1)" style="width:100%;display:flex;align-items:center;justify-content:center;gap:10px;background:#c15a33;color:#ffffff;border:none;border-radius:14px;padding:18px 24px;font-size:17px;font-weight:700;cursor:pointer;font-family:inherit;letter-spacing:0.4px;">
          ...
          <?php /* Ovdje je stajala DRUGA kopija harmonike, za telefon. Ista lista
                   karakteristika — dimenzije, boja, montaza, cijena po m² — bila
                   je time ispisana dva puta na svakoj od 117 stranica proizvoda:
                   jednom ispod slike (za racunar), jednom ovdje (za telefon).
                   CSS je jednu od njih krio, ali su obje isle Google-u i objema
                   je rastao HTML.
                   Sada postoji jedan ispis, a redoslijed na telefonu se rjesava
                   CSS-om (vidi `display: contents` u style-v5.css). */ ?>
          <?php else: ?>
    ...
    <div class="srodni-sekcija">
      <div class="gold-line"></div>
      <h2 class="section-title srodni-naslov">Slični Proizvodi</h2>
