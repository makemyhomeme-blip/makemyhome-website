...
<style id="info-page">
  ...
  .calc { background: #ffffff; border: 1px solid rgba(201,168,108,0.35); border-radius: 16px; padding: 24px; margin: 22px 0; }
  ...
  .info-cta { background: #ffffff; border: 1px solid rgba(201,168,108,0.35); border-radius: 16px;
