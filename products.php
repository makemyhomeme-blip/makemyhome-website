...
?>
  ...
  <style>
    ...
    .cat-card-info p  { font-size: 13px; color: #888; margin-bottom: 8px; line-height: 1.5; }
    .cat-card-count {
...
-->
      ...
      <div>
        ...
        <ul class="footer-links">
          ...
          <li><a href="paneli-za-kupatilo.html"><i class="fas fa-chevron-right"></i> Paneli za kupatilo</a></li>
          <li><a href="tv-zid.html"><i class="fas fa-chevron-right"></i> Zid iza TV-a</a></li>
          <li><a href="paneli-ili-lamperija.html"><i class="fas fa-chevron-right"></i> Paneli ili lamperija</a></li>
          <li><a href="akusticni-paneli-kancelarija.html"><i class="fas fa-chevron-right"></i> Akustika u kancelariji</a></li>
          <li><a href="spc-ili-laminat.html"><i class="fas fa-chevron-right"></i> SPC ili laminat</a></li>
          <li><a href="dostava-crna-gora.html"><i class="fas fa-chevron-right"></i> Dostava po Crnoj Gori</a></li>
          ...
          <li><a href="uslovi.html"><i class="fas fa-chevron-right"></i> Uslovi kupovine</a></li>
          <li><a href="reklamacije.html"><i class="fas fa-chevron-right"></i> Reklamacije i povrat</a></li>
          <li><a href="privatnost.html"><i class="fas fa-chevron-right"></i> Politika privatnosti</a></li>
        </ul>
      </div>
      <div>
