...
// Kombinacije: ista slika kod dva proizvoda -> u galeriji se prikaze JEDNOM
// (preskacemo duplikate) i dobija oznaku "Kombinacija".
$mmhKombiIns = mmhKombiInspiracija($insP);
$mmhKombiSkip = $mmhKombiIns['skip'] ?? [];
$mmhKombiFoto = $mmhKombiIns['combo'] ?? [];
...
<head><meta charset="utf-8">
  ...
  <style>
    ...
    .faq-group-title{display:flex;align-items:center;gap:12px;font-family:var(--font-heading);font-size:22px;color:var(--dark);margin:0 0 20px;padding-bottom:12px;border-bottom:2px solid rgba(0,0,0,0.3);}
    ...
    .faq-item h3 span.q{color:#1a1a1a;font-weight:800;flex-shrink:0;}
...
<style id="info-page">
  ...
  .info-wrap a { color: #1a1a1a; font-weight: 600; }
  .step { display: flex; gap: 18px; align-items: flex-start; background: #ffffff;
          border: 1px solid rgba(0,0,0,0.28); border-radius: 14px; padding: 20px 22px; margin-bottom: 14px; }
  .step-n { flex-shrink: 0; width: 36px; height: 36px; border-radius: 50%; background: #1a1a1a; color: #1a1a1a;
  ...
  .info-table tr:hover td { background: #ffffff; }
  .info-table a { white-space: nowrap; }
  .tbl-scroll { overflow-x: auto; -webkit-overflow-scrolling: touch; }
  .calc { background: #ffffff; border: 1px solid rgba(0,0,0,0.35); border-radius: 16px; padding: 24px; margin: 22px 0; }
  ...
  .calc-f input:focus, .calc-f select:focus { outline: none; border-color: #1a1a1a; }
  ...
  .info-cta { background: #ffffff; border: 1px solid rgba(0,0,0,0.35); border-radius: 16px;
